        ...
        <div className="col-lg-4">
          <div className="widget-content">
            <div className="disclamer-box">
              <h5>Disclaimer</h5>
              <p>
                Create patient record by entering their name and contact
                information
              </p>
              <p>
                This will send an email with a pre-consultation form they must
                complete to book an appointment on the calendar
              </p>
            </div>
          </div>
        </div>
        ...
        <Modal.Body className="p-0">
          ...
          <div className="p-3">
            ...
            <p>
              ...
              aliquid, eos inventore iure accusantium blanditiis provident,
              delectus suscipit nesciunt, nostrum ut praesentium ratione
              perspiciatis modi ullam iusto. Velit, enim impedit.
            </p>
          </div>
        </Modal.Body>
        <Modal.Footer>
