  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-white">
      <div className="p-8 w-full max-w-md text-center">
        <p className="text-[#6096B4] text-[10px] mb-1">Let's get started</p>
        ...
        <div className="space-y-4">
          <div className="flex items-center border shadow-md p-2">
            <FaUser className="text-[#666666] mr-2" />
            <input
              type="text"
          ...
          <div className="flex items-center border shadow-md p-2">
            <FaPhone className="text-[#666666] mr-2" />
            <input
              type="text"
          ...
          <p className="text-[#666666]">
            Already have an account? <a href="/patient/signin">Signin</a>
          </p>
          <p className="text-[#666666]">
            Want to Sign Up as doctor? <a href="/signin">Click here</a>
          </p>
