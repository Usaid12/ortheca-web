    ...
    <div className="flex justify-center items-center min-h-screen bg-pink-500 gap-2">
      ...
      <div className="flex justify-center items-center  max-w-xl w-full rounded-2xl pb-2 pt-2 bg-white">
        <div className="p-8 w-full max-w-md text-center">
          <p className="text-black font-semibold md:text-4xl text-xl mb-4 ">Sign In</p>
          ...
          <div className="space-y-4">
            ...
            <p className="text-[#666666]">
              Don't have an account? <a href="/patient/signup" className="decoration-white">Signup</a>
            </p>
