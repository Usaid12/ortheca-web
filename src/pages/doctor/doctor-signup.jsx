                ...
                <div className="p-8 w-full max-w-md text-center">
                    ...
                    <div className="space-y-4  ">
                        ...
                        <p className="text-[#666666] ">
                            Already have an account? <a href="/signin" className="decoration-white ">Signin</a>
                        </p>
                        <p className="text-[#666666]">
                            Want to Sign Up as patient? <a href="/patient/signup" className="decoration-white">Click here</a>
                        </p>
