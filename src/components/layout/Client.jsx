  ...
  return (
    <>
      ...
      <main className="relative flex">
        <button
          className="md:hidden p-2 text-gray-600 fixed top-4 right-4 z-50 bg-white shadow-lg rounded-full"
          onClick={() => setIsSidebarOpen(!isSidebarOpen)}
        >
          <FaBars size={24} />
        </button>
        <div
          className={`client-sidebar-content fixed inset-y-0 left-0 w-64 transform ${
